    ...
    <main class="flex flex-1 items-center justify-center bg-gradient-to-r from-emerald-200 to-lime-200 min-h-screen">
        <main class="min-h-screen bg-gradient-to-r from-emerald-100 to-lime-100 py-12 px-4 sm:px-6 lg:px-8">
            <div class="max-w-4xl mx-auto">
                ...
                <form action="{{ route('proprietaire.store') }}" method="POST" enctype="multipart/form-data" x-data="{ type: '' }" class="space-y-8">
                    @csrf
                    ...
                    <div x-show="type" x-cloak class="bg-white rounded-xl shadow-lg p-6 transition duration-300 hover:shadow-xl">
                        ...
                        <div x-show="type === 'Bail'" class="space-y-4">
                            ...
                            <x-file-input label="Notification d'Attribution de Parcelle" name="notification_attribution"/>
                            <x-file-input label="Extrait de Plan Cadastral" name="extrait_plan"/>
                            <x-file-input label="Quittance de Paiement" name="quittance_paiement"/>
                        </div>
