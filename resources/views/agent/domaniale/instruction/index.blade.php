<x-layout>
    ...
    <main class="flex-1 bg-teal-50 p-8">
        <div class="container mx-auto space-y-8">
            <h2 class="text-2xl md:text-4xl font-bold text-center mb-8">Instruction dossier de construction</h2>
                ...
                <table class="min-w-full bg-white divide-y divide-gray-300">
                    ...
                    <tbody class="text-gray-700 bg-white">
                        ...
                        <tr class="even:bg-gray-50">
                            ...
                            <td class="whitespace-nowrap py-4 px-3 text-sm text-gray-900">{{ $dossier->parcelle->numeroLot }}</td>
                            ...
                            <td class="whitespace-nowrap py-4 px-3 text-sm">
                                <a href="route('domaniale.instruction.show')" target="_blank" class="text-indigo-600 hover:text-emerald-400">Voir</a>
                            </td>
