            ...
            <div class="container mx-auto space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="bg-white p-4 rounded-lg shadow-md">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#50C878" class="size-10">
                          ...
                          <p class="ml-4 text-3xl text-emerald-500">{{ $totalDossiers }}</p>
                        </span>
                        <h3 class="text-xl font-bold text-emerald-500 mb-2 mt-3">Nombre Total de demandes</h3>
                        <p class="text-sm">Voir et éditer les dossiers en attentes</p>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-md">
                        <span class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" height="45px" class="size-10" viewBox="0 -960 960 960" width="45px" fill="#50C878">
                                ...
                                <p class="ml-4 text-3xl text-emerald-500">{{ $totalExtraits }}</p>
                        </span>
                        <h3 class="text-xl font-bold text-emerald-500 mb-2 mt-3">Demande d'extrait de Plan</h3>
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-md">
                        <span class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" height="45px" class="size-10" viewBox="0 -960 960 960" width="45px" fill="#50C878">
                                ...
                                <p class="ml-4 text-3xl text-emerald-500">{{ $totalBails }}</p>
                        </span>
                        <h3 class="text-xl font-bold text-emerald-500 mb-2 mt-3">Demandes de Bail</h3>
                ...
                <form action="{{ route('cadastrale.index') }}" method="GET" class="flex items-center bg-white p-4 rounded-lg shadow-md space-x-4">
                        ...
                        <tbody class="text-gray-700 bg-white">
                            ...
                            <tr class="even:bg-gray-50">
                                ...
                                <td class="whitespace-nowrap py-4 px-3 text-sm">
                                    <a href="{{ route('cadastrale.show', $dossier->id) }}" class="text-indigo-600 hover:text-emerald-400">Voir</a>
                                </td>

                                <td x-data class="inline-flex relative whitespace-nowrap py-4 pl-3 pr-4 sm:pr-3 text-sm text-right font-medium">
                                    <a href="{{ route('cadastrale.edit', $dossier->id) }}" class="text-indigo-600 hover:text-emerald-400">
                                        <span class="flex items-center">
