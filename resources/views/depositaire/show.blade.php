...
<head>
    ...
    <title>{{ config('app.name').' | '. $dossier->type }}</title>
            ...
            <div class="flex justify-center bg-emerald-700">
                ...
                <div class="px-6 py-4">
                    ...
                    <div class="mt-4">
                        ...
                        <p class="text-lg font-medium text-gray-900">{{ $dossier->statut }}</p>
                    </div>
                    <div class="mt-4">
                    ...
                    <div class="mt-4">
                        ...
                        <ul class="mt-2">
                            @forelse($dossier->pieceDossier as $piece)
                                <li><a href="#" class="text-blue-500 hover:underline">{{ $piece->nom }}</a></li>
                                    @empty
